...
class EsenIconButton extends StatefulWidget {
  const EsenIconButton({
    Key? key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  State<EsenIconButton> createState() => _EsenIconButtonState();
}

class _EsenIconButtonState extends State<EsenIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(EsenIconButton oldWidget) {
