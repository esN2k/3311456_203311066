...
class ESENButtonOptions {
  const ESENButtonOptions({
    this.textStyle,
    this.elevation,
    this.height,
    this.width,
...
class ESENButtonWidget extends StatefulWidget {
  const ESENButtonWidget({
    Key? key,
    required this.text,
  ...
  final ESENButtonOptions options;
  final bool showLoadingIndicator;

  @override
  State<ESENButtonWidget> createState() => _ESENButtonWidgetState();
}

class _ESENButtonWidgetState extends State<ESENButtonWidget> {
  bool loading = false;
