...
abstract class EsenTheme {
  ...
  static EsenTheme of(BuildContext context) {
...
class LightModeTheme extends EsenTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color secondary = const Color(0xFF7A63FF);
  late Color tertiary = const Color(0xFFFFB905);
...
class DarkModeTheme extends EsenTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
