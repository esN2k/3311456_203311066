...
import '../../esen/lat_lng.dart';
import '../../esen/place.dart';
import '../../esen/uploaded_file.dart';
...
String uploadedFileToString(ESENUploadedFile uploadedFile) =>
  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.FFUploadedFile:
        return uploadedFileToString(param as ESENUploadedFile);
      case ParamType.JSON:
...
ESENUploadedFile uploadedFileFromString(String uploadedFileStr) =>
    ESENUploadedFile.deserialize(uploadedFileStr);
