...
Widget wrapWithModel<T extends EsenModel>({
  required T model,
...
T createModel<T extends EsenModel>(
...
class EsenDynamicModels<T extends EsenModel> {
  EsenDynamicModels(this.defaultBuilder);
