      ...
      appBar: AppBar(
        ...
        leading: InkWell(
          ...
          child: Icon(
            ...
            color: EsenTheme.of(context).primaryText,
            size: 32.0,
          ),
        ),
        title: Text(
          'Şifremi Unuttum ',
          style: EsenTheme.of(context).headlineMedium,
        ),
        actions: [],
        centerTitle: false,
        elevation: 0.0,
          ...
          children: [
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: EsenTheme.of(context).bodyMedium,
                  ...
                  filled: true,
                  fillColor: EsenTheme.of(context).secondaryBackground,
                  contentPadding:
                      EdgeInsetsDirectional.fromSTEB(20.0, 24.0, 20.0, 24.0),
                ),
                style: EsenTheme.of(context).titleSmall,
            ...
            Padding(
              ...
              child: ESENButtonWidget(
                ...
                text: 'Şifre Sıfırlama Linki Yolla',
                options: ESENButtonOptions(
                  ...
                  textStyle: EsenTheme.of(context).titleSmall.override(
                        ...
                        color: EsenTheme.of(context).secondaryBackground,
                        fontSize: 16.0,
